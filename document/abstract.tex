...
\vspace{6mm}
\begin{tabular}{l c}
    \heiti\zihao{3}{\textbf{Title}}&\songti\zihao{4}\uline{\makebox[24em][c]{The first line of your thesis title}}\\  % 您的论文标题第一行
    &\songti\zihao{4}\uline{\makebox[24em][c]{The second line of your thesis title}}  % 您的论文标题第二行
    % 此处因页边距更改，将原27em改为24em
\end{tabular}
\vspace{4mm}
\newline
% 外文摘要
...
\setlength{\parindent}{24pt}
  ...
  % 根据2025版官方要求，外文摘要段落前取消缩进，在每一段前添加 '\noindent'

  \noindent The abstract of the undergraduate graduation thesis is a high-level summary of the entire research work, usually including the background of the research
  ...
  \noindent The keywords for undergraduate graduation thesis should accurately summarize the core content and research field of the thesis, which is helpful for reading
